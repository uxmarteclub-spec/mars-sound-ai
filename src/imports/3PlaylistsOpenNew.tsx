import svgPaths from "./svg-upld88zslp";
...
function Frame7() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[615px]">
      ...
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="fi-rr-cross">
...
function ModalPlaylist() {
  return (
    <div className="bg-[#24191b] content-stretch flex flex-col gap-[24px] items-start justify-center p-[24px] relative shrink-0" data-name="modal-playlist">
      <div aria-hidden="true" className="absolute border border-[#30292b] border-solid inset-0 pointer-events-none" />
      <Frame7 />
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col h-[1126px] items-center justify-center left-[299px] top-[113px] w-[1429px]">
      <ModalPlaylist />
    </div>
  );
}

export default function Component3PlaylistsOpenNew() {
  return (
    <div className="bg-black relative size-full" data-name="3 -Playlists-open-new">
